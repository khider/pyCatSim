# -*- coding: utf-8 -*-
"""
Owner class for managing cats and feeding them.

This module defines the Owner class, which can feed cats and manage their hunger and mood.
"""
...
class Owner:
    ...
    cats_owned : Cat or list of Cat
        A single Cat instance or a list of Cat instances representing the owner's cats.
